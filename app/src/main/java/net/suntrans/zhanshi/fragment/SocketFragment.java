...
public class SocketFragment extends RxFragment {


    private String userid;
    private String id;

    public static final SocketFragment newInstance(String channel_type, String id) {
...
//        getActivity().unbindService(connection);
    ...
    public void getData() {
        if (getDataObj == null) {
            getDataObj = RetrofitHelper.getApi().getRoomSocket(id)
